...
- fixture 기반 시나리오 확장은 baseline 변경 전 별도 설계가 필요하며, 현재 Queue payload validator와 live-read checks는 standalone manual tooling boundary까지 정리됐고 submit normalization / Notion mapping은 다음 fixture 후보로 선정됐다.
...
## 지금 바로 수정해도 안전한 항목
- submit fixture plan을 별도 docs-only 문서로 작성
