...
- fixture 기반 시나리오 확장은 baseline 변경 전 별도 설계가 필요하며, fixture validation 방식 설계 전까지 runner/compare, baseline, scenario index 변경은 아직 하지 않는다.

## 다음 단일 후보
- Queue payload fixture validation 방식 설계를 먼저 진행한다.
