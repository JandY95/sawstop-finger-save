...
## 원격 R2 확인 명령 예시
- `npx.cmd wrangler r2 object get "sawstop-attachments/attachments/202604121252-5678/0001_1775980881697_finger1.jpg" --remote --file C:\temp\finger1-remote.jpg`
...
9. 필요 시 원격 R2 객체 직접 확인
   - `npx.cmd wrangler r2 object get "sawstop-attachments/<R2 Key>" --remote --file C:\temp\check.bin`
